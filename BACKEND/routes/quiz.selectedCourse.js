...
const quizSelectedCourse = require("../controllers/OpenAI/quizSelectedCourse.controller");
...
router.post('/', quizSelectedCourse.career_Choice_Selected_Course);
router.get("/", quizSelectedCourse.Get_career_Choice_Selected_Course);
